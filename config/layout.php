...
return [
    ...
    'aside' => [
        ...
        'menu' => [
            ...
            'submenu' => [
                ...
                'dropdown' => [
                    'arrow' => true,
                    'hover-timeout' => 0 // in milliseconds
                ]
            ]
        ]
    ],
    ...
    'resources' => [
        ...
        'fonts' => [
            'google' => [
                'families' => [
                    ...
                    'Montserrat Alternates:300,400,500,600,700',
                    // 'Redressed:300,400,500,600,700',
                ]
            ]
        ],
		'logincss' => [
        ...
        'css' => [
            ...
            'plugins/custom/custom_fullcalendar/style.css',
            'plugins/custom/custom_fullcalendar/responsive.css',
        ],
        'js' => [
            ...
            'plugins/custom/custom_fullcalendar/script.js', 
            // 'plugins/custom/custom_fullcalendar/jquery_ui.js', 
