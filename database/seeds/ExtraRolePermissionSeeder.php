...
class ExtraRolePermissionSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        //     'description' => "Be able to delete appointment",
        //     'grouping' => 'appointment',
        // ]); 
        ...
        Permission::firstOrCreate([
            ...
            'description' => 'Be able to view distributors listing page & detail page',
            'grouping' => 'Distributor',
        ]);
        Permission::firstOrCreate([
            'display_name' => 'Create Distributor',
            'name' => 'distributor-create',
            'description' => 'Be able to create a distributor',
            'grouping' => 'Distributor',
        ]);  
        Permission::firstOrCreate([
            'display_name' => 'Edit Distributor',
            'name' => 'distributor-edit',
            'description' => 'Be able to edit a distributor',
            'grouping' => 'Distributor',
        ]);  
         ...
         */
        Permission::firstOrCreate([
            'display_name' => 'View Master module',
            'name' => 'master-modules-view',
            'description' => 'Be able to view Master modules listing',
            'grouping' => 'Master Modules',
        ]);    
    }
}
