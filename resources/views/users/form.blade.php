                ...
                <div class="col-sm-4">
                    <div class="form-group form-group-error">
                        ...
                        <select name="user_type" id="user_type" class="form-control">
                            <option value="0" data-user-type="system_user">System User</option>
                            <option value="2" data-user-type="distributor">Distributor</option>
                        </select> 
...
<div class="wizard-footer height-wizard d-flex flex-wrap"> 
    ...
    <div class="pull-right flex-grow">
        ...
        {!! Form::submit($submitButtonText . $name_title, ['class' => 'btn btn-finish btn-fill btn-primary btn-wd btn-sm', 'id' => 'submitEmployeee']) !!} 
    </div>
