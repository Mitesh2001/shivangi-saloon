...
<div class="card card-custom">
	<div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label">SMS Template</h3>
		</div>
		<div class="card-toolbar">
		@if(\Entrust::can('sms-create') && !$allow_view_only)
            <a href="{{ route('sms.create') }}" class="btn btn-primary mr-3">Create Template</a>
		@endif
            ...
            init: function () {
                $("#kt_datatable").DataTable({
                    ...
                    columns: [   
                        ...
                        {data: 'name', name: 'name'},         
                        {data: 'event', name: 'event', width: "30%"},         
                        
                        @if(Entrust::can('sms-edit'))
                        { data: 'action', name: 'action', orderable: false, searchable: false, class:'fit-action-delete-th table-actions', width: "5%"},
                        @endif 
                    ]
                })
            }
