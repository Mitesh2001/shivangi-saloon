	...
	<div class="form">
		<div class="card-body">
			<div class="form-group row"> 
				@if($is_system_user == 0)
					@if(isset($holiday))
						<input type="hidden" name="distributor_id" id="distributor_id" value="{{ $holiday->distributor_id }}">
					@else
		...
		<div class="card-footer">
			<div class="row">
				<div class="col-lg-6">
					...
					{!! Form::submit($submitButtonText, ['class' => 'btn btn-md btn-primary', 'id' => 'submitHoliday']) !!} 
					{!! Form::reset("Cancel", ['class' => 'btn btn-light-primary font-weight-bold', 'id' => 'submitHoliday']) !!}
				</div> 
			</div>
		</div>
	</div>
