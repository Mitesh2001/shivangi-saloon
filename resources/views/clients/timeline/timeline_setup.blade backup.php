        ...
        <div class="row">
            <div class="col-md-6 col-lg-3"> 
                <div class="card shadow-sm separator separator-dashed separator-border-2 separator-primary card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url( {{ asset('media/svg/shapes/abstract-3.svg') }} )">
                    <!--begin::Body-->
                    <div class="card-body my-4">
                        <p class="card-title remove-flex font-weight-bolder text-primary font-size-h2 mb-4 text-hover-state-dark d-block">No Risk</p>
                        <div class="font-weight-bold text-muted d-flex flex-column text-center justify-content-around">
                        ...
                        <div class="range-values text-center mt-6">
                            <span class="label label-md label-primary label-inline font-weight-bolder mr-2">Last visits &nbsp; <span id="no-risk-days">0</span> &nbsp; days back </span> 
            ...
            <div class="col-md-6 col-lg-3"> 
                <div class="card shadow-sm separator separator-dashed separator-border-2 separator-primary card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url( {{ asset('media/svg/shapes/abstract-3.svg') }} )">
                    <!--begin::Body-->
                    <div class="card-body my-4">
                        <p class="card-title remove-flex font-weight-bolder text-primary font-size-h2 mb-4 text-hover-state-dark d-block">Dormant Clients</p>
                        <div class="font-weight-bold text-muted d-flex flex-column text-center justify-content-around">
            ...
            <div class="col-md-6 col-lg-3"> 
                <div class="bg-danger-o-50 card shadow-sm separator separator-dashed separator-border-2 separator-primary card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url( {{ asset('media/svg/shapes/abstract-3.svg') }} )">
                    <!--begin::Body-->
                    <div class="card-body my-4">
                        <p class="card-title remove-flex font-weight-bolder text-primary font-size-h2 mb-4 text-hover-state-dark d-block">At Risk</p>
                        <div class="font-weight-bold text-muted d-flex flex-column text-center justify-content-around">
                        <span class="text-dark-75 font-weight-bolder font-size-h1 mr-2" id="at-risk-clients-display"></span></div>
                        <div class="mt-3">
                            <div id="at_risk" style="width: 100%"></div> 
                        </div>
                        <div class="range-values text-center mt-4">
                            <span class="label label-md label-primary label-inline font-weight-bolder mr-2">From : &nbsp;<span id="at-risk-from">0</span></span> 
                            <span class="label label-md label-primary label-inline font-weight-bolder mr-2">To : &nbsp;<span id="at-risk-to">200</span></span> 

                            <input type="hidden" name="at_risk_min" id="at_risk_min_input" value="0">
                            <input type="hidden" name="at_risk_max" id="at_risk_max_input" value="0">
                            @if($distributor_id == 0) 
                            <a href="#" class="btn btn-primary btn-block mt-5" id="at_risk_view">View</a>
                            @endif
                        </div>
                    </div>
                    <!--end::Body-->
            ...
            <div class="col-md-6 col-lg-3"> 
                <div class="bg-danger-o-50 card shadow-sm separator separator-dashed separator-border-2 separator-primary card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url( {{ asset('media/svg/shapes/abstract-3.svg') }} )">
                    <!--begin::Body-->
                    <div class="card-body my-4">
                        <p class="card-title remove-flex font-weight-bolder text-primary font-size-h2 mb-4 text-hover-state-dark d-block">Lost/Churn</p>
                        <div class="font-weight-bold text-muted d-flex flex-column text-center justify-content-around">
                        ...
                        <div class="range-values text-center mt-6">
                            <span class="label label-md label-primary label-inline font-weight-bolder mr-2">Last visits &nbsp; <span id="lost-days">0</span> &nbsp; days back </span> 
