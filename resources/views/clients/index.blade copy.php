...
@if($status_wise == 1)
	@section('title', 'Clients List '. $status_name)
@else
			...
			<div class="row">
					<div class="col-md-6 col-lg-3"> 
						<div class="card shadow-sm separator separator-dashed separator-border-2 separator-primary card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url( {{ asset('media/svg/shapes/abstract-3.svg') }} )">
							...
							<div class="card-body my-4 text-center">
								<p class="card-title font-weight-bolder text-primary font-size-h2 mb-4 text-hover-state-dark d-block status-card-title custom-md-h2custom-md-h2 ">New Clients</p>
									<div class="font-weight-bold text-muted d-flex flex-column text-center justify-content-around">
										...
										<a href="{{ route('clients_timeline.ClientsList') . '?status=new_clients' }}" class="btn btn-primary">View</a>
									</div>
								</div>
							<!--end::Body-->
						</div>
					...
					<div class="col-md-6 col-lg-3"> 
						<div class="card shadow-sm separator separator-dashed separator-border-2 separator-primary card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url( {{ asset('media/svg/shapes/abstract-3.svg') }} )">
							...
							<div class="card-body my-4">
								<p class="card-title font-weight-bolder text-primary font-size-h2 mb-4 text-hover-state-dark d-block status-card-title custom-md-h2">Repeating Clients</p>
								<div class="font-weight-bold text-muted d-flex flex-column text-center justify-content-around">
									<span class="text-dark-75 font-weight-bolder font-size-h1 mr-2" id="repeating-clients-display"></span>
									<a href="{{ route('clients_timeline.ClientsList') . '?status=repeating_clients' }}" class="btn btn-primary">View</a>
								</div>
								</div>
							<!--end::Body-->
						</div>
					...
					<div class="col-md-6 col-lg-3"> 
						<div class="card shadow-sm separator separator-dashed separator-border-2 separator-primary card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url( {{ asset('media/svg/shapes/abstract-3.svg') }} )">
							<!--begin::Body-->
							<div class="card-body my-4">
								<p class="card-title font-weight-bolder text-primary font-size-h2 mb-4 text-hover-state-dark d-block status-card-title custom-md-h2">Regular Clients</p>
								<div class="font-weight-bold text-muted d-flex flex-column text-center justify-content-around">
								<span class="text-dark-75 font-weight-bolder font-size-h1 mr-2" id="regular-clients-display"></span>
									<a href="{{ route('clients_timeline.ClientsList') . '?status=regular_clients' }}" class="btn btn-primary">View</a>
								</div>
							</div>
							<!--end::Body-->
						</div>
					...
					<div class="col-md-6 col-lg-3"> 
						<div class="card shadow-sm separator separator-dashed separator-border-2 separator-primary card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url( {{ asset('media/svg/shapes/abstract-3.svg') }} )">
							<!--begin::Body-->
							<div class="card-body my-4">
								<p class="card-title font-weight-bolder text-primary font-size-h2 mb-4 text-hover-state-dark d-block status-card-title custom-md-h2">Never Visited</p>
								<div class="font-weight-bold text-muted d-flex flex-column text-center justify-content-around">
								<span class="text-dark-75 font-weight-bolder font-size-h1 mr-2" id="never-visited-clients-display"></span>
									<a href="{{ route('clients_timeline.ClientsList') . '?status=never_visited' }}" class="btn btn-primary">View</a>
								</div>
							</div>
							<!--end::Body-->
						</div>
				...
				<div class="row">
					<div class="col-md-6 col-lg-3"> 
						<div class="card shadow-sm separator separator-dashed separator-border-2 separator-primary card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url( {{ asset('media/svg/shapes/abstract-3.svg') }} )">
							<!--begin::Body-->
							<div class="card-body my-4">
								<p class="card-title font-weight-bolder text-primary font-size-h2 mb-4 text-hover-state-dark d-block status-card-title custom-md-h2">No Risk</p>
								<div class="font-weight-bold text-muted d-flex flex-column text-center justify-content-around">
								<span class="text-dark-75 font-weight-bolder font-size-h1 mr-2" id="no-risk-clients-display"></span>
									<a href="{{ route('clients_timeline.ClientsList') . '?status=no_risk' }}" class="btn btn-primary">View</a>
								</div>
							</div>
							<!--end::Body-->
						</div>
					...
					<div class="col-md-6 col-lg-3"> 
						<div class="card shadow-sm separator separator-dashed separator-border-2 separator-primary card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url( {{ asset('media/svg/shapes/abstract-3.svg') }} )">
							<!--begin::Body-->
							<div class="card-body my-4">
								<p class="card-title font-weight-bolder text-primary font-size-h2 mb-4 text-hover-state-dark d-block status-card-title custom-md-h2">Dormant Clients</p>
								<div class="font-weight-bold text-muted d-flex flex-column text-center justify-content-around">
								<span class="text-dark-75 font-weight-bolder font-size-h1 mr-2" id="dormant-clients-display"></span>
									<a href="{{ route('clients_timeline.ClientsList') . '?status=dormant_clients' }}" class="btn btn-primary">View</a>
								</div>
							</div>
							<!--end::Body-->
						</div>
					...
					<div class="col-md-6 col-lg-3"> 
						<div class="card shadow-sm separator separator-dashed separator-border-2 separator-primary card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url( {{ asset('media/svg/shapes/abstract-3.svg') }} )">
							<!--begin::Body-->
							<div class="card-body my-4">
								<p class="card-title font-weight-bolder text-primary font-size-h2 mb-4 text-hover-state-dark d-block status-card-title custom-md-h2">At Risk</p>
								<div class="font-weight-bold text-muted d-flex flex-column text-center justify-content-around">
								<span class="text-dark-75 font-weight-bolder font-size-h1 mr-2" id="at-risk-clients-display"></span>
									<a href="{{ route('clients_timeline.ClientsList') . '?status=at_risk' }}" class="btn btn-primary">View</a>
								</div>
							</div>
							<!--end::Body-->
						</div>
					...
					<div class="col-md-6 col-lg-3"> 
						<div class="card shadow-sm separator separator-dashed separator-border-2 separator-primary card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url( {{ asset('media/svg/shapes/abstract-3.svg') }} )">
							<!--begin::Body-->
							<div class="card-body my-4">
								<p class="card-title font-weight-bolder text-primary font-size-h2 mb-4 text-hover-state-dark d-block status-card-title custom-md-h2">Lost/Churn</p>
								<div class="font-weight-bold text-muted d-flex flex-column text-center justify-content-around">
								<span class="text-dark-75 font-weight-bolder font-size-h1 mr-2" id="lost-clients-display"></span>
									<a href="{{ route('clients_timeline.ClientsList') . '?status=lost_clients' }}" class="btn btn-primary">View</a>
								</div>
							</div>
							<!--end::Body-->
						</div>
...
<div class="card card-custom">
	<div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label">
				Clients
				@if($status_wise == 1) 
					<span class="text-muted">( {{ $status_name }} )</span> 	
				@endif
			</h3>
		</div>
		<div class="card-toolbar">
	...
	<div class="card-body">
		...
		<div class="table-responsive">
			<!--begin: Datatable-->
			<table class="table table-hover" id="kt_datatable" style="margin-top: 13px !important; min-height:200px !important">
				<thead>
					<tr>
						<th>Salon</th> 				
...
@section('scripts')
    ...
    <script>
		...
		init: function () {
			if(is_system_user) {
				var print_columns = [0, 3, 4, 5, 6, 7, 8, 9, 10];
			} else {
				var print_columns = [3, 4, 5, 6, 7, 8, 9, 10];
			}
