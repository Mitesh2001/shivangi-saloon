...
<div class="card card-custom">
	<div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label">Inquiry Types</h3>
		</div>
		<div class="card-toolbar">
		@if(\Entrust::can('inquiry-type-create'))
            <a href="{{ route('enquirytype.create') }}" class="btn btn-primary mr-3">Create Inquiry Type</a>
		@endif
