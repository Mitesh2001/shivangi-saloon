...
@section('title', 'Products/Service List')
...
<div class="card card-custom">
	<div class="card-header">
		<div class="card-title">
			...
			<h3 class="card-label">Products/Service</h3>
		</div>
		<div class="card-toolbar">  
		@if(\Entrust::can('product-create') && !$allow_view_only)
			<a href="{{ route('product.create') }}" class="btn btn-primary mr-3">Create Product/Service</a>
		@endif
		...
		<table class="table table-hover table-list" id="kt_datatable" style="margin-top: 13px !important">
			<thead>
				<tr>
					<th>Salon</th> 					
					<th>
						<select name="distributor_filter" class="form-control width-auto" id="distributor_filter">
					...
					<th>Categories</th>					
					<th>
						<select name="type_filter" class="form-control width-auto" id="type_filter">
							<option value="" data-searchid>All Types</option>
							<option value="product" data-searchid>Products</option>
							<option value="service" data-searchid>Services</option>
							<option value="package" data-searchid>packages</option>
						</select>
					</th> 					
    ...
    <script>
		...
		var KTDatatablesDataSourceAjaxServer = {
			init: function () {
				...
				if(is_system_user) {
					var print_columns = [0, 3, 4, 5, 7, 8, 9];
				} else {
					var print_columns = [3, 4, 5, 7, 8, 9];
				}
				...
				$("#kt_datatable").DataTable({
					...
					columns: [
						...
						{data: 'thumbnail', name: 'image', orderable: false, searchable: false}, 
