...
@section('title', "Orders list of ". $client_data->name)
	...
	<div class="card-header">
		<div class="card-title remove-flex">
			...
			@if(!empty($client_data)) 
				<span class="text-muted">  (Client Name : {{ isset($client_data) ? $client_data->name : null }}) </span>
			@endif 
		</div>
		<div class="card-toolbar">
		@if(\Entrust::can('order-create') && !$allow_view_only)
