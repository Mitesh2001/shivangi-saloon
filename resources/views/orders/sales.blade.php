			...
			<table class="table table-hover table-list" id="kt_datatable" style="margin-top: 13px !important">
				<thead>
					<tr> 		
						...
						<td>
							<select name="type_filter" id="type_filter" style="width:100%">
								<option value="" data-searchid>All</option> 
    ...
    <script> 
        ...
        var KTDatatablesDataSourceAjaxServer = {
            init: function () {
				...
				if(is_system_user) {
					var print_columns = [0, 2, 4, 5, 7, 8]
				} else {
					var print_columns = [2, 4, 5, 7, 8]
				}
                ...
                $("#kt_datatable").DataTable({
                    ...
                    columns: [   
						...
						{data: 'product_type', name: 'product_type', visible: false}, 
