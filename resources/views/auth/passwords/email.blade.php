                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/password/email') }}">
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12 input-group-lg">
                                    <input type="email" class="form-control" style="border-radius: 4px; box-shadow:0px 2px 4px rgba(0,0,0,0.18); padding-right:40px;" placeholder="E-Mail address" name="email" value="{{ old('email') }}" pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="Please eter valid email address!">
