...
class CommentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!array_key_exists($request->type, $modelsMapping)) {
            Session::flash('success_warning', __('Could not create comment, type not found! Please contact Daybyday support'));
        ...
        Session::flash('success', __('Comment successfully added')); //Snippet in Master.blade.php
        return redirect()->back();
    }
}
